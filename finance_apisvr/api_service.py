...
def class_pred(list_text):
    ...
    with BertClient(ip='192.168.11.57', port=5575, port_out=5576, show_server_config=False, check_version=False,
    ...
    # 返回结构为：
    # rst: [{'pred_label': ['0', '1'], 'score': [0.9983683228492737, 0.9988993406295776}]
    # 抽取出标注结果
...
def flask_server(args):
    ...
    @app.route('/api/v0.0.1/query', methods=['POST'])
    def query():
        res = {}
